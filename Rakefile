...
SOURCE_LIST = file_list SRC, 'vanadium-jquery.js', 'vanadium-callbacks.js', 'vanadium-hashmap.js', 'vanadium-container.js', 'vanadium-form.js', 'vanadium-base.js', 'vanadium-utils.js', 'vanadium-dom.js', 'vanadium-element.js', 'vanadium-instance.js', 'vanadium-types.js', 'vanadium-init.js'
